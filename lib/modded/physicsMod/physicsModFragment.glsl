...
// Physics Mod constants (Required for compilation)
const int PHYSICS_ITERATIONS_OFFSET = 3;
const float PHYSICS_NORMAL_STRENGTH = 1.0;
const float PHYSICS_XZ_SCALE = 0.1;
const float PHYSICS_W_DETAIL = 0.1;
const float PHYSICS_DRAG_MULT = 0.048;
const float PHYSICS_FREQUENCY = 6.0;
const float PHYSICS_SPEED = 1.0;
const float PHYSICS_WEIGHT = 0.8;
const float PHYSICS_FREQUENCY_MULT = 1.3;
const float PHYSICS_TIME_MULTIPLICATOR = 0.8;
const float PHYSICS_SPEED_MULT = 1.1;
const float PHYSICS_ITER_INC = 0.85;
