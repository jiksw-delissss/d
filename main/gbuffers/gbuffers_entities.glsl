...
/// -------------------------------- /// Fragment Shader /// -------------------------------- ///
    ...
    // outlines for entities are applied in the deferred pass to avoid compile-time issues
    ...
    void main(){
        ...
        // Note: entity outlines intentionally skipped here to keep entity shaders compatible.
        // Outlines are applied later in the deferred pass where the full HDR buffer is available.
